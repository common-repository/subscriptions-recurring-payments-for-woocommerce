jQuery(function($) {
	...
	$.extend({
		awc_format_money: function(value,decimal_precision) {
			return window.accounting.formatMoney(
				value,
				{
					symbol: awc_reports.currency_format_symbol,
					format: awc_reports.currency_format,
					decimal: awc_reports.currency_format_decimal_sep,
					thousand: awc_reports.currency_format_thousand_sep,
