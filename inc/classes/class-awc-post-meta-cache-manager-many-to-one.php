 ...
 * only one cache should exist for the meta value. This differs to awc_Post_Meta_Cache_Manager
 * which allows multiple caches for the same meta value i.e. a many-to-many relationship.
 *
 */
class AWC_Post_Meta_Cache_Manager_Many_To_One extends AWC_Post_Meta_Cache_Manager {
