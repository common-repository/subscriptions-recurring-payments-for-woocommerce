...
class AWC_Modal {
	...
	public static function enqueue_scripts_and_styles() {
		wp_enqueue_script( 'asub-modal-scripts', plugin_dir_url( AWC_Subscriptions::$plugin_file ) . 'assets/js/frontend-modal.js', array( 'jquery' ), AWC_Subscriptions::$version, true );
		wp_enqueue_style( 'asub-modal-styles', plugin_dir_url( AWC_Subscriptions::$plugin_file ) . 'assets/css/modal.css', array( 'dashicons' ), AWC_Subscriptions::$version );
	}
	 ...
	 * @param array            $actions      Optional. An array of actions to add to the modal. See {@see 'awc_Modal::add_action'} for details on the action array format.
	 */
	...
	public function print_html() {
		wc_get_template( 'modal/html-modal.php', array( 'modal' => $this ), '', plugin_dir_path( AWC_Subscriptions::$plugin_file ) . 'temp/' );
	}
