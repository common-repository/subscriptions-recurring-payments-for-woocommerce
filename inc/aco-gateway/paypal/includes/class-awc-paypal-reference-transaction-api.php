...
class AWC_PayPal_Reference_Transaction_API extends AWC_SV_API_Base {
	...
	public function are_reference_transactions_enabled() {
		...
		$this->set_response_handler( 'AWC_PayPal_Reference_Transaction_API_Response' );
	 ...
	 * @return AWC_PayPal_Reference_Transaction_API_Response_Checkout response object
	...
	public function set_express_checkout( $args ) {
		...
		$this->set_response_handler( 'AWC_PayPal_Reference_Transaction_API_Response_Checkout' );
	 ...
	 * @return AWC_PayPal_Reference_Transaction_API_Response_Billing_Agreement response object
	...
	public function create_billing_agreement( $token ) {
		...
		$this->set_response_handler( 'AWC_PayPal_Reference_Transaction_API_Response_Billing_Agreement' );
	 ...
	 * @param array $args
	 * @return AWC_PayPal_Reference_Transaction_API_Response_Payment refund response
	 */
	public function do_express_checkout( $token, $order, $args ) {
		...
		$this->set_response_handler( 'AWC_PayPal_Reference_Transaction_API_Response_Payment' );
	...
	public function do_reference_transaction( $reference_id, $order, $args ) {
		...
		$this->set_response_handler( 'AWC_PayPal_Reference_Transaction_API_Response_Recurring_Payment' );
	...
	public function get_callback_url( $action ) {
		return add_query_arg( 'action', $action, WC()->api_request_url( 'awc_paypal' ) );
	}

	/**
	 * Builds and returns a new API request object
	 *
	 * @see \AWC_SV_API_Base::get_new_request()
	 * @param array $args
	 * @return WC_PayPal_Reference_Transaction_API_Request API request object
	 */
	protected function get_new_request( $args = array() ) {
		return new AWC_PayPal_Reference_Transaction_API_Request( $this->api_username, $this->api_password, $this->api_signature, self::VERSION );
	}

	/**
	 * Supposed to return the main gatewya plugin class, but we don't have one of those
	 *
	 * @see \awc_SV_API_Base::get_plugin()
	 * @return object
	 
	 */
	protected function get_plugin() {
		return AWC_PayPal::instance();
	}
}
