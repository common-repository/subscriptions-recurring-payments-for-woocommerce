...
class AWC_PayPal_Reference_Transaction_API_Response_Payment extends AWC_PayPal_Reference_Transaction_API_Response_Billing_Agreement {
	...
	public function get_status_message() {
		...
		if ( $this->transaction_held() ) {
			...
			$message = sprintf( __( 'expected clearing date %s', 'subscriptions-recurring-payments-for-woocommerce' ), date_i18n( wc_date_format(), awc_date_to_time( $this->get_payment_parameter( 'EXPECTEDECHECKCLEARDATE' ) ) ) );
		}
	 ...
	 *
	 * A wrapper around @see awc_PayPal_Reference_Transaction_API_Response::has_parameter()
	 ...
	 *
	 * A wrapper around @see awc_PayPal_Reference_Transaction_API_Response::get_parameter()
	 * that prepends the @see self::get_payment_parameter_prefix().
	 *
	 .9
	 * @param string $name parameter name
