 ...
 *
 */
class AWC_Email_On_Hold_Subscription extends WC_Email {
	...
	function __construct() {
		...
		$this->title       = __( 'Suspended Subscription', 'subscriptions-recurring-payments-for-woocommerce' );
		$this->description = __( 'Suspended Subscription emails are sent when a customer manually suspends their subscription.', 'subscriptions-recurring-payments-for-woocommerce' );

		$this->heading     = __( 'Subscription Suspended', 'subscriptions-recurring-payments-for-woocommerce' );
		// translators: placeholder is {blogname}, a variable that will be substituted when email is sent out
		$this->subject     = sprintf( _x( '[%s] Subscription Suspended', 'default email subject for suspended emails sent to the admin', 'subscriptions-recurring-payments-for-woocommerce' ), '{blogname}' );

		$this->template_html  = 'emails/on-hold-subscription.php';
		$this->template_plain = 'emails/text/on-hold-subscription.php';
