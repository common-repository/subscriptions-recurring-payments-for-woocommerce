 ...
 *
 */
class AWC_Email_Processing_Renewal_Order extends WC_Email_Customer_Processing_Order {
	...
	function __construct() {
		...
		$this->title          = __( 'Processing Renewal order', 'subscriptions-recurring-payments-for-woocommerce' );
		$this->description    = __( 'This is an order notification sent to the customer after payment for a subscription renewal order is completed. It contains the renewal order details.', 'subscriptions-recurring-payments-for-woocommerce' );
		$this->customer_email = true;

		$this->heading        = __( 'Thank you for your order', 'subscriptions-recurring-payments-for-woocommerce' );
		$this->subject        = __( 'Your {blogname} renewal order receipt from {order_date}', 'subscriptions-recurring-payments-for-woocommerce' );

		$this->template_html  = 'emails/customer-processing-renewal-order.php';
		$this->template_plain = 'emails/text/customer-processing-renewal-order.php';
