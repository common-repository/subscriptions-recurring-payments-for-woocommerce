...
class AWC_Privacy_Background_Updater {
	 ...
	 */
	public function awc_schedule_ended_subscription_anonymization() {
	...
	public function anonymize_ended_subscriptions() {
		...
		$this->awc_schedule_ended_subscription_anonymization();

		$batch_size = 20;

		// Get the ended_statuses and removes pending-cancel.
		$subscription_ended_statuses = array_diff( awc_get_subscription_ended_statuses(), array( 'pending-cancel' ) );
