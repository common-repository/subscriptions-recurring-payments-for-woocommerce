/* global awc_paypal_payment_generate_cart_context */
;(function( $, window, document ) {
	...
	var generate_cart = function( callback ) {
		var data = {
			'nonce': awc_paypal_payment_generate_cart_context.generate_cart_nonce,
			'attributes': {},
		};
		...
		$.ajax( {
			type:    'POST',
			data:    data,
			url:     awc_paypal_payment_generate_cart_context.ajaxurl,
			success: callback,
		} );
	};

	window.awc_paypal_payment_generate_cart = generate_cart;
