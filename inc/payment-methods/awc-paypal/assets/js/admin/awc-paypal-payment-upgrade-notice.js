;(function ( $, window, document ) {
	...
	// Plugin rows.
	let $notice_row = $( 'tr#awc-paypal-migration-notice' );
	...
	// Dismiss button.
	$( document).on( 'click', '#awc-paypal-migration-notice button.notice-dismiss', function( e ) {
		$.ajax(
			{
				url: ajaxurl,
				method: 'POST',
				data: {
					action: 'awc_paypal_payment_gateway_dismiss_upgrade_notice',
