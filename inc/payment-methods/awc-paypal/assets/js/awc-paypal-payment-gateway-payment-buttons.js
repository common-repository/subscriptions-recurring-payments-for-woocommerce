...
;( function ( $, window, document ) {
	...
	var showError = function( errorMessage, selector ) {
		...
		$container.prepend( '<div class="omar woocommerce-NoticeGroup woocommerce-NoticeGroup-checkout">' + errorMessage + '</div>' );
			...
			payment: function() {
				...
				return new Promise( function( resolve, reject ) {
					...
					if ( 'product' === wc_ppec_context.page && ! isMiniCart ) {
						window.awc_paypal_payment_generate_cart( resolve );
					} else {
						resolve();
					}
				} ).then( function() {
