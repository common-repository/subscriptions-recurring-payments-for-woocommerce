...
/**
 * Implementation is duplicated in AWC_Paypal_Payment_Gateway_For_SPB.
 */


class AWC_Paypal_Payment_Gateway_For_SPB extends AWC_Paypal_Payment_Gateway {
	...
	public function payment_scripts() {
		if ( ! awc_paypal_ec_gateway()->checkout->has_active_session() ) {
			wp_register_script( 'awc-paypal-gateway-orderreview', awc_paypal_ec_gateway()->plugin_url . 'assets/js/awc-paypal-gateway-orderreview.js', array( 'jquery' ), awc_paypal_ec_gateway()->version, true );
			wp_enqueue_script( 'awc-paypal-gateway-orderreview');
		}
	}
