...
// AWC_Paypal_Payment_Gateway_Client_Credential

// abstract-wc-gateway-ppec-client-credential.php
// abstract-class-awc-paypal-payment-gateway-client-credential.php
abstract class AWC_Paypal_Payment_Gateway_Client_Credential {
	...
	public function configure_curl( $handle, $r, $url ) {
		curl_setopt( $handle, CURLOPT_CAINFO, AWC_Paypal_Payment_Methods_for_Subscription::$includes_path . 'pem/awc_paypal_payment.pem' ); // phpcs:ignore WordPress.WP.AlternativeFunctions.curl_curl_setopt
	}
}
