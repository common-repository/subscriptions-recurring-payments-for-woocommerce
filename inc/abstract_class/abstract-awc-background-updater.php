...
abstract class AWC_Background_Updater {
	...
	public function init() {
		...
		$this->time_limit = apply_filters( 'awc_debug_tools_time_limit', $this->time_limit, $this );
	...
	public function run_update() {
		...
		$start_time = $this->is_wp_cli_request() ? gmdate( 'U' ) : awc_INIT_TIMESTAMP;
