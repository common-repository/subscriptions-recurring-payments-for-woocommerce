 ...
 *
 * Schedulers are responsible for triggering subscription events/action, 
 * like when a payment is due or subscription expires.
 *
 
 */
abstract class AWC_Scheduler {
	...
	public function set_date_types_to_schedule() {
		$date_types_to_schedule = awc_get_subscription_date_types();
