...
printf( __( 'A subscription belonging to %1$s has been cancelled. Their subscription\'s details are as follows:', 'subscriptions-recurring-payments-for-woocommerce' ), $subscription->get_formatted_billing_full_name() );
...
if ( ! empty( $end_time ) ) {
	...
	echo sprintf( __( 'End of Prepaid Term: %s', 'subscriptions-recurring-payments-for-woocommerce' ), date_i18n( wc_date_format(), $end_time ) ) . "\n";
}
