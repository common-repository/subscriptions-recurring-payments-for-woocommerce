...
<p><?php esc_html_e( 'Thanks for your renewal order. It’s on-hold until we confirm that payment has been received. In the meantime, here’s a reminder of your order:', 'subscriptions-recurring-payments-for-woocommerce' ); ?></p>

<?php

/*
 * @hooked AWC_Subscriptions_Email::order_download_details() Shows the order details table.
